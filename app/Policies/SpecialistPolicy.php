...
class SpecialistPolicy
{
    ...
    {
        return $user->can('view_any_specialist');
    }
    ...
    {
        return $user->can('delete_any_specialist');
    }
    ...
    {
        return $user->can('force_delete_specialist');
    }
    ...
    {
        return $user->can('force_delete_any_specialist');
    }
    ...
    {
        return $user->can('restore_specialist');
    }
    ...
    {
        return $user->can('restore_any_specialist');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Specialist $specialist): bool
    {
        return $user->can('replicate_specialist');
    }
    ...
    {
        return $user->can('reorder_specialist');
    }
}
